/**
 * SEO slug yardımcıları — backend/src/slug.js ile aynı kurallar.
 */
...
export function extractCitySlug(address) {
...
export function cityDisplayName(citySlug, lang = "tr") {
  const mapTr = {
    lefkosa: "Lefkoşa",
    girne: "Girne",
...
export function buildBusinessSlug({ institutionId, institution_id, name, institution_name } = {}) {
...
export function buildBranchSlug(branch, institutionName = "") {
...
export function exchangeOfficePath(slug) {

  ...
  return (
    ...
    >
      <img
        ...
        decoding="async"
        className={`block w-auto shrink-0 object-contain object-left transition-all duration-300 hover:opacity-90 brightness-[0.88] contrast-[1.12] saturate-[1.08] dark:brightness-100 dark:contrast-100 dark:saturate-100 ${
          compact
            ? "-my-0.5 h-10 sm:h-11"
            : "-my-2 h-16 sm:-my-2.5 sm:h-[4.5rem] md:-my-3 md:h-[5rem]"
        } ${imgClassName}`}
      />
    </Link>
  );
